...
var TAB_NAME = 'holders';
export default function Holder() {
  var isMobile = useMobileAll();
  var searchParams = useSearchParams();
  var chain = searchParams.get('chainId');
  var itemSymbol = searchParams.get('itemSymbol') || '';
  var _useSearchAfterParams = useSearchAfterParams(25, TAB_NAME),
    ...
    defaultSearchAfter = _useSearchAfterParams.defaultSearchAfter;
  ...
  var _useState11 = useState(defaultPageType),
    _useState12 = _slicedToArray(_useState11, 2),
    pageType = _useState12[0],
    setPageType = _useState12[1];
  var mountRef = useRef(false);
  var updateQueryParams = useUpdateQueryParams();
  var fetchHolderDataWrap = useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          setLoading(true);
          _context.prev = 1;
          sort = getSort(pageType, currentPage);
          searchAfter = getHoldersSearchAfter(currentPage, data, pageType);
          try {
            if (mountRef.current) {
              updateQueryParams({
                p: currentPage,
