...
export default function ItemActivityTable(props) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          searchAfter = getTransferSearchAfter(currentPage, data, pageType);
          try {
            if (mountRef.current) {
              updateQueryParams({
                p: currentPage,
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "collection-transfers-table"
  }, /*#__PURE__*/React.createElement(Table, {
    headerTitle: {
      single: {
        title: "A total of ".concat(total, " records found")
      }
    },
    showTopSearch: true,
