...
var TAB_NAME = 'PortkeyTx';
export default function List() {
  var isMobile = useMobileAll();
  var _useSearchAfterParams = useSearchAfterParams(TablePageSize.mini, 'PortkeyTx'),
    defaultPage = _useSearchAfterParams.defaultPage,
    defaultPageSize = _useSearchAfterParams.defaultPageSize,
    defaultPageType = _useSearchAfterParams.defaultPageType;
  var _useState = useState(Number(defaultPage)),
    _useState2 = _slicedToArray(_useState, 2),
    currentPage = _useState2[0],
    setCurrentPage = _useState2[1];
  var _useState3 = useState(Number(defaultPageSize)),
  ...
  var _useState11 = useState('Age'),
    _useState12 = _slicedToArray(_useState11, 2),
    timeFormat = _useState12[0],
    setTimeFormat = _useState12[1];
  var _useState13 = useState(defaultPageType),
    _useState14 = _slicedToArray(_useState13, 2),
    pageType = _useState14[0],
    setPageType = _useState14[1];
  var _useParams = useParams(),
    chain = _useParams.chain,
    address = _useParams.address;
  var mountRef = useRef(false);
  var searchParams = useSearchParams();
  var defaultSearchAfter = searchParams.get('searchAfter');
  var activeTab = searchParams.get('tab') === TAB_NAME;
  var updateQueryParams = useUpdateQueryParams();
  var fetchData = useCallback( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page, pageSize, data, pageType) {
      var sort, searchAfter, params, res;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sort = getSort(pageType, page);
            searchAfter = getAddressSearchAfter(page, data, pageType);
            setLoading(true);
            params = {
              chainId: chain,
            ...
            _context.prev = 5;
            _context.next = 8;
            return fetchTransactionList(params);
          case 8:
            res = _context.sent;
            setTotal(res.total);
  ...
  var multiTitle = useMemo(function () {
  ...
  var pageSizeChange = function pageSizeChange(page, size) {
    setPageSize(size);
    setCurrentPage(page);
    setPageType(PageTypeEnum.NEXT);
